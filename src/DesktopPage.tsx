...
const imgChatGptImage1320251735561 = "http://localhost:3845/assets/9a2ea7309518ee76a6b97175e1aa7477a7cfc0fc.png";
const imgChatGptImage1320251802081 = "http://localhost:3845/assets/90ec21a8e07043728f8fdadfb5773adc70c3b66e.png";
const imgChatGptImage1320251737291 = "http://localhost:3845/assets/4a99f27e97f28314170723b56e93bfdc867d868a.png";
const imgChatGptImage132025175029 = "http://localhost:3845/assets/a31d752484cb75bd4215525705c86961266bebee.png";
const imgChatGptImage1320251738531 = "http://localhost:3845/assets/cb9636fa326937888360f117de63def7956a4533.png";
const imgChatGptImage132025175238 = "http://localhost:3845/assets/061e136ba2bf5647e14f796954062344e97ad218.png";
...
const imgExclude = "http://localhost:3845/assets/399db38bf930f2ec3cf1b6160b9aea716c8ce1b0.svg";
const imgExclude1 = "http://localhost:3845/assets/1f9eed437b28824178664c5debfadc4c7e54bf47.svg";
const imgExclude2 = "http://localhost:3845/assets/ceb6f9cfb25e77f68abf27bde0c8212fd9a7afc8.svg";
    ...
    <div className="w-full overflow-x-hidden bg-white">
      ...
      <div className="bg-white h-[700px] overflow-clip relative shrink-0 w-full" data-name="17" data-node-id="78:2">
        ...
        <div className="-translate-x-1/2 absolute border-[1.802px] border-[var(--color,#1f556b)] border-solid h-[58.563px] left-[calc(16.67%+73.17px)] overflow-clip rounded-[45.048px] top-[399px] w-[373px]" data-node-id="78:5">
          <p className="-translate-x-1/2 absolute font-['Geologica:Regular',sans-serif] font-normal leading-[normal] left-1/2 not-italic text-[19.911px] text-[color:var(--color,#1f556b)] text-center top-[15.2px] uppercase" data-node-id="78:6" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
