  ...
  return (
    <div className="bg-[var(--color,#1f556b)] relative size-full" data-name="Mobile" data-node-id="83:1375">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[448.284px] left-[177px] overflow-clip rounded-[77.962px] top-[334px] w-[727px]" data-node-id="83:1377">
        <div className="absolute border-[1.949px] border-[var(--color,#1f556b)] border-solid inset-[66.96%_6.97%_11.3%_6.97%] rounded-[97.453px]" data-node-id="83:1378" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[73.38%_52.21%_17.92%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color,#1f556b)] tracking-[0.874px]" data-node-id="83:1380" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[69.13%_8.42%_13.66%_80.97%]" data-name="Exclude" data-node-id="83:1381">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[448.284px] left-[177px] overflow-clip rounded-[77.962px] top-[1903.84px] w-[727px]" data-node-id="83:1385">
        <div className="absolute border-[1.949px] border-[var(--color,#1f556b)] border-solid inset-[66.96%_6.97%_11.3%_6.97%] rounded-[97.453px]" data-node-id="83:1386" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[73.39%_52.21%_17.91%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color,#1f556b)] tracking-[0.874px]" data-node-id="83:1388" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[69.13%_8.42%_13.66%_80.97%]" data-name="Exclude" data-node-id="83:1389">
          <img alt="" className="absolute block max-w-none size-full" src={imgExclude} />
        </div>
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[448.284px] left-[177px] overflow-clip rounded-[77.962px] top-[857.28px] w-[727px]" data-node-id="83:1393">
        <div className="absolute border-[1.949px] border-[var(--color,#1f556b)] border-solid inset-[66.95%_6.97%_11.31%_6.97%] rounded-[97.453px]" data-node-id="83:1394" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[73.38%_52.21%_17.92%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color,#1f556b)] tracking-[0.874px]" data-node-id="83:1396" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[69.13%_8.42%_13.66%_80.97%]" data-name="Exclude" data-node-id="83:1397">
          <img alt="" className="absolute block max-w-none size-full" src={imgExclude} />
        </div>
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[448.284px] left-[177px] overflow-clip rounded-[77.962px] top-[1380.56px] w-[727px]" data-node-id="83:1409">
        <div className="absolute border-[1.949px] border-[var(--color,#1f556b)] border-solid inset-[66.96%_6.97%_11.3%_6.97%] rounded-[97.453px]" data-node-id="83:1410" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[73.38%_52.21%_17.92%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color,#1f556b)] tracking-[0.874px]" data-node-id="83:1412" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[69.13%_8.42%_13.66%_80.97%]" data-name="Exclude" data-node-id="83:1413">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[448.284px] left-[177px] overflow-clip rounded-[77.962px] top-[2427px] w-[727px]" data-node-id="83:1417">
        <div className="absolute border-[1.949px] border-[var(--color,#1f556b)] border-solid inset-[66.96%_6.97%_11.3%_6.97%] rounded-[97.453px]" data-node-id="83:1418" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[73.39%_52.21%_17.91%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color,#1f556b)] tracking-[0.874px]" data-node-id="83:1420" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[69.13%_8.42%_13.66%_80.97%]" data-name="Exclude" data-node-id="83:1421">
          <img alt="" className="absolute block max-w-none size-full" src={imgExclude} />
        </div>
