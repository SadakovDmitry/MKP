const imgImage30 = "http://localhost:3845/assets/931b6633863d1f54a5fc4411e8d68e92170b9644.png";
const imgImage32 = "http://localhost:3845/assets/fd2feb640c8e531cfacca0277edea7ff68ecea7f.png";
const imgImage31 = "http://localhost:3845/assets/38c93582bc755349ad4bcef1516f2c8f81b8cf05.png";
const imgImage33 = "http://localhost:3845/assets/60a83ebdd7f5d44a2f9856f2b9435915d6c51445.png";
const imgExclude = "http://localhost:3845/assets/b64dd81d1a35824c308ed72b9711d0a00eedd245.svg";
const imgExclude1 = "http://localhost:3845/assets/ee77955046f0fc75092854add3bc73ef4db13648.svg";
const imgExclude2 = "http://localhost:3845/assets/6bb0d15635f2923b7f782e24ebf7c6401041f5bf.svg";
const imgExclude3 = "http://localhost:3845/assets/6f378aae965602164109861c6e749b9386f7b4dd.svg";
  ...
  return (
    <div className="bg-[var(--color-2,#44b1d2)] relative size-full" data-name="Mobile" data-node-id="83:1679">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[918.008px] left-[177px] overflow-clip rounded-[77.962px] top-[333px] w-[727px]" data-node-id="83:1681">
        ...
        <div className="absolute bg-[var(--color-3,#313131)] inset-[83.86%_6.97%_5.52%_6.97%] rounded-[97.453px]" data-node-id="83:1683" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[87%_33.78%_8.75%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color-4,white)] tracking-[0.874px]" data-node-id="83:1685" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Перейти к закону
        </p>
        <div className="absolute inset-[84.92%_8.42%_6.67%_80.97%]" data-name="Exclude" data-node-id="83:1686">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[918.008px] left-[177px] overflow-clip rounded-[77.962px] top-[2353.09px] w-[727px]" data-node-id="83:1690">
        ...
        <div className="absolute bg-[var(--color-3,#313131)] inset-[83.86%_6.97%_5.52%_6.97%] rounded-[97.453px]" data-node-id="83:1692" />
        ...
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[87%_43.82%_8.75%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color-4,white)] tracking-[0.874px]" data-node-id="83:1694" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Читать статью
        </p>
        <div className="absolute inset-[84.93%_8.42%_6.67%_80.97%]" data-name="Exclude" data-node-id="83:1695">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[438.539px] left-[177px] overflow-clip rounded-[77.962px] top-[1326.01px] w-[727px]" data-node-id="83:1699">
        ...
        <div className="absolute bg-[var(--color-3,#313131)] inset-[66.22%_6.97%_11.55%_6.97%] rounded-[97.453px]" data-node-id="83:1701" />
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[72.79%_52.21%_18.32%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color-4,white)] tracking-[0.874px]" data-node-id="83:1702" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[68.44%_8.42%_13.96%_80.97%]" data-name="Exclude" data-node-id="83:1703">
      ...
      <div className="absolute bg-[var(--color-4,white)] h-[438.539px] left-[177px] overflow-clip rounded-[77.962px] top-[1839.55px] w-[727px]" data-node-id="83:1707">
        ...
        <div className="absolute bg-[var(--color-3,#313131)] inset-[66.22%_6.97%_11.55%_6.97%] rounded-[97.453px]" data-node-id="83:1709" />
        <p className="absolute font-['Geologica:ExtraLight',sans-serif] font-extralight inset-[72.79%_52.21%_18.32%_13.67%] leading-[0.9] not-italic text-[43.701px] text-[color:var(--color-4,white)] tracking-[0.874px]" data-node-id="83:1710" style={{ fontVariationSettings: "\'CRSV\' 0, \'SHRP\' 0" }}>
          Подробнее
        </p>
        <div className="absolute inset-[68.44%_8.42%_13.96%_80.97%]" data-name="Exclude" data-node-id="83:1711">
